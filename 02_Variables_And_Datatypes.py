...
ii) list: An ordered, mutable collection of items (which can be of different data types).
...
memoryview: A memory view object allows you to access the internal data of an object that supports the buffer protocol.
